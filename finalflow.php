...
echo "Thank you for performing this task for <strong>" . $firstname . ' ' . $lastname . "</strong>.Their number is <strong>" . $number . 
"</strong> if you need to get in contact.";

echo "<h4 class='listingslink'><a href='listings.php'>Find another job</a></h4><br />";
